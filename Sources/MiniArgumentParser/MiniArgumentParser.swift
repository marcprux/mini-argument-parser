// MiniArgumentParser is a miniture stripped-down version of a full-fledged argument parser
// distributed as a single file for use in command-line tools and plugins for which an external dependency
// can be burdensome.

// This code is mostly derived from https://github.com/apple/swift-argument-parser/archive/refs/tags/1.2.3.zip
